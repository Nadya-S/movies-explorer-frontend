      ...
      <div className="about-me__info">
        <div className="about-me__text">
          ...
          <p className="about-me__story">
            Здесь будет история. Здесь будет история. Здесь будет история. Здесь
            будет история.Здесь будет история. Здесь будет история.Здесь будет
            история. Здесь будет история.
          </p>
          <a
